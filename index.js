...
app.get('/products/:productId/reviews', async (req, res) => {
	...
	try {
		const response = await request(
			`${returnScraperApiUrl(api_key)}&url=https://www.amazon.com/product-reviews/${productId}`
		);
...
app.get('/products/:productId/offers', async (req, res) => {
	...
	try {
		const response = await request(
			`${returnScraperApiUrl(api_key)}&url=https://www.amazon.com/gp/offer-listing/${productId}`
		);
